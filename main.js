...
◦ *الوقت المتصل*: ${new Date().toLocaleString()}\n\n حسابي على الفايسبوك للمزيد من المعلومات \nhttps://www.facebook.com/NX.2026`;
...
global.reloadHandler = async function(restatConn) {
    ...
    conn.welcome = 'مرحبا بك في مجموعة الرجاء قراءة قوانين المجموعة حتى لا يتم طردك  ، سيلانا اول بوت واتساب في الوطن العربي \n\n welcome to the groupe please read the rules of the group\n\n\n @subject, @user\n'
